...
class rabbitMqAlertTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        rabbitmqalert.setup_options_real = rabbitmqalert.setup_options
    ...
    def tearDown(self):
        ...
        rabbitmqalert.setup_options = rabbitmqalert.setup_options_real
    ...
    def test_setup_options_returns_default_options_when_no_options_given(self):
        ...
        options_result = rabbitmqalert.setup_options()
