...
class OptionsResolver:
    ...
    def setup_options(self):
        ...
        arguments.add_option("--queue-consumers-connected", dest="queue-consumers-connected", help="The number of consumers that should be connected to the queue", type="int") 
