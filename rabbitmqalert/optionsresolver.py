...
class OptionsResolver:
    ...
    def setup_options(self):
        ...
        arguments.add_option("--queue_consumers-connected", dest="queue_consumers_connected", help="The number of consumers that should be connected to the queue", type="int")
